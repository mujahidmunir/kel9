                ...
                <div class="col-12">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="{{url('auth/google')}}" class="btn btn-danger btn-block"><i class="fa fa-google">&nbsp;</i>Register
                                        With Google</a>
                                </div>
                            </div>
                            ...
                            <form action="{{route('register')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="floating-label form-group">
                                            <input type="password"
                                                   class="floating-input form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="floating-label form-group">
                                            <input id="password-confirm" type="password" class="floating-input form-control"  name="password_confirmation" required >
