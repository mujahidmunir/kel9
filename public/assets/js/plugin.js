!function () {
    ...
    t.fn.TouchSpin = function (i) {
        ...
        return this.each(function () {
            ...
            var u, m, f, g, w, v, y, z, x, _, b = t(this), C = b.data(), T = 0, W = !1;
            !function () {
                if (!b.data("alreadyinitialized")) {
                    ...
                    }), a), i)).initval && "" === b.val() && b.val(u.initval), r(), function () {
                        var e = b.val(), i = b.parent();
    ...
    t.fn.themePin = function (e) {
        var i = 0, o = 0, s = [], n = !1, r = t(window), a = [], h = [], l = [];
        e = e || {};
        var p = function () {
            for (var i = 0, o = s.length; i < o; i++) {
                ...
                if (e.minWidth && r.width() <= e.minWidth) a.parent().is(".pin-wrapper") && a.unwrap(), a.css({
                    ...
                    if (void 0 !== p) {
                        ...
                        a.css("border-bottom", f), a.css({width: a.outerWidth() <= a.parent().width() ? a.outerWidth() : a.parent().width()}), a.parent().css("height", a.outerHeight() + w), a.outerHeight() <= r.height() ? a.data("themePin", {
                            pad: d,
            ...
            if (!n) {
                ...
                for (var p = window.innerHeight || r.height(), c = 0, d = s.length; c < d; c++) {
                    var u, m = t(s[c]), f = m.data("themePin");
                    if (f) {
                        ...
                        if (f.end = g.offset().top + g.height(), w ? f.to = g.offset().top + g.height() - m.outerHeight() - f.pad.bottom - f.pb : (f.to = g.offset().top + g.height() - p - f.pb, f.to2 = g.height() - m.outerHeight() - f.pad.bottom - f.pb), 0 === l[c] && (l[c] = f.to), l[c] != f.to && h[c] && m.height() + m.offset().top + f.pad.bottom < i + p && (h[c] = !1), w) {
                            var v = f.from - f.pad.bottom, y = f.to - f.pad.top - f.offset;
        ...
        return this.each(function () {
            var e = t(this), i = t(this).data("themePin") || {};
